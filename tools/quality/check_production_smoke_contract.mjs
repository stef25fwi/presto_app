...
requireText("'<link rel=\"canonical\" href=\"https://ilipresto.fr/confidentialite\">'", 'canonical exact confidentialité');
requireText("'<link rel=\"canonical\" href=\"https://ilipresto.fr/suppression-compte\">'", 'canonical exact suppression compte');
requireText("'<title>Politique de confidentialité'", 'title statique confidentialité');
requireText("'<title>Suppression du compte'", 'title statique suppression compte');
