  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: const [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.search_rounded), label: "Offres"),
        ...
        BottomNavigationBarItem(icon: Icon(Icons.person_outline_rounded), label: "Compte"),
      ],
    );
  }
}
...
/// Page d'informations légales — iliprestō
