      ...
      child: Column(
        children: [
          const Padding(
            ...
            child: Text(
              'Moyens de paiement possibles sur iliprestō',
              textAlign: TextAlign.center,
              style: TextStyle(
                color: kBlueDark,
                fontSize: 17,
          ...
          ...methods.map((m) => _PaymentRow(method: m)),
        ],
      ),
    );
  }
...
class _Method {
  const _Method(this.icon, this.color, this.title, this.subtitle);
...
class _PaymentRow extends StatelessWidget {
  const _PaymentRow({required this.method});
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const Icon(Icons.chevron_right_rounded, color: kBlueDark),
        ],
      ),
    );
  }
