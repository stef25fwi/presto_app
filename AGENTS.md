...
A collection of 37 specialized AI subagents for use with Claude Code, sourced
from [contains-studio/agents](https://github.com/contains-studio/agents). Each
agent is a focused expert that Claude Code activates automatically based on the
context of your request, or that you can invoke explicitly by name.
