# FICHE MÉTIER — Installation TV / support mural — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Installation TV / support mural
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Installation TV / support mural**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Installation TV / support mural**, l’application doit donc afficher :
...
Coûts indicatifs pour **Installation TV / support mural** :
...
1. Décrire précisément l’activité Installation TV / support mural.
...
id_fiche : fonctionnaire_installation_tv_support_mural
titre : Installation TV / support mural — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Installation TV / support mural
