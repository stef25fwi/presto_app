# FICHE MÉTIER — Réparation portail / clôture — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Réparation portail / clôture
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Réparation portail / clôture**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Réparation portail / clôture**, l’application doit donc afficher :
...
Coûts indicatifs pour **Réparation portail / clôture** :
...
1. Décrire précisément l’activité Réparation portail / clôture.
...
id_fiche : fonctionnaire_reparation_portail_cloture
titre : Réparation portail / clôture — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Réparation portail / clôture
