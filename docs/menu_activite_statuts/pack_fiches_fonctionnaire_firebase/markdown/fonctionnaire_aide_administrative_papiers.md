# FICHE MÉTIER — Aide administrative / papiers — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Aide administrative / papiers
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Aide administrative / papiers**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Aide administrative / papiers**, l’application doit donc afficher :
...
Coûts indicatifs pour **Aide administrative / papiers** :
...
1. Décrire précisément l’activité Aide administrative / papiers.
...
id_fiche : fonctionnaire_aide_administrative_papiers
titre : Aide administrative / papiers — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Aide à domicile
activite : Aide administrative / papiers
