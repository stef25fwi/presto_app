# FICHE MÉTIER — Préparation examens / concours — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Préparation examens / concours
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Préparation examens / concours**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Préparation examens / concours**, l’application doit donc afficher :
...
Coûts indicatifs pour **Préparation examens / concours** :
...
1. Décrire précisément l’activité Préparation examens / concours.
...
id_fiche : fonctionnaire_preparation_examens_concours
titre : Préparation examens / concours — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Préparation examens / concours
