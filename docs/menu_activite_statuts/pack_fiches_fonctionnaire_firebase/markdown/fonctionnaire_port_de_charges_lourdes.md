# FICHE MÉTIER — Port de charges lourdes — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Port de charges lourdes
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Port de charges lourdes**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Port de charges lourdes**, l’application doit donc afficher :
...
Coûts indicatifs pour **Port de charges lourdes** :
...
1. Décrire précisément l’activité Port de charges lourdes.
...
id_fiche : fonctionnaire_port_de_charges_lourdes
titre : Port de charges lourdes — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Port de charges lourdes
