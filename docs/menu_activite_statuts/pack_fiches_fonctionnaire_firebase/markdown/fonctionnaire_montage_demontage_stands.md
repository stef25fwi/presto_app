# FICHE MÉTIER — Montage / démontage stands — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Montage / démontage stands
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Montage / démontage stands**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Montage / démontage stands**, l’application doit donc afficher :
...
Coûts indicatifs pour **Montage / démontage stands** :
...
1. Décrire précisément l’activité Montage / démontage stands.
...
id_fiche : fonctionnaire_montage_demontage_stands
titre : Montage / démontage stands — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Montage / démontage stands
