# FICHE MÉTIER — Montage de meubles — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Montage de meubles
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Montage de meubles**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Montage de meubles**, l’application doit donc afficher :
...
Coûts indicatifs pour **Montage de meubles** :
...
1. Décrire précisément l’activité Montage de meubles.
...
id_fiche : fonctionnaire_montage_de_meubles
titre : Montage de meubles — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Montage de meubles
