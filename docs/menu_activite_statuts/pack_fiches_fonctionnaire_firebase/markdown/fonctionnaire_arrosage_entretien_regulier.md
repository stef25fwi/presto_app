# FICHE MÉTIER — Arrosage / entretien régulier — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Arrosage / entretien régulier
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Arrosage / entretien régulier**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Arrosage / entretien régulier**, l’application doit donc afficher :
...
Coûts indicatifs pour **Arrosage / entretien régulier** :
...
1. Décrire précisément l’activité Arrosage / entretien régulier.
...
id_fiche : fonctionnaire_arrosage_entretien_regulier
titre : Arrosage / entretien régulier — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Arrosage / entretien régulier
