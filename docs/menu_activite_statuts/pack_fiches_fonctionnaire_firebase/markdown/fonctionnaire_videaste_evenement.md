# FICHE MÉTIER — Vidéaste événement — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Vidéaste événement
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Vidéaste événement**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Vidéaste événement**, l’application doit donc afficher :
...
Coûts indicatifs pour **Vidéaste événement** :
...
1. Décrire précisément l’activité Vidéaste événement.
...
id_fiche : fonctionnaire_videaste_evenement
titre : Vidéaste événement — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : Vidéaste événement
