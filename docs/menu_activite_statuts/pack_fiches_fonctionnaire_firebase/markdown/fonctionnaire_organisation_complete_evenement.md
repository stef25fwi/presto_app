# FICHE MÉTIER — Organisation complète événement — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Organisation complète événement
Statut utilisateur : Fonctionnaire / agent public
Famille : Événementiel / DJ
Type d’activité : Prestation événementielle, animation, photo/vidéo ou organisation
Activité réglementée : oui
Niveau de vigilance : élevé
Code APE indicatif : 90.02Z, 90.01Z, 74.20Z, 82.30Z ou 93.29Z selon activité — à confirmer
Nature fiscale probable : prestation_services_bic_ou_bnc
Organismes principaux : Administration employeur, Guichet unique INPI, Urssaf, Sacem si musique, Préfecture/mairie si événement public, DRAC/préfecture si spectacle vivant
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Organisation complète événement**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Organisation complète événement**, l’application doit donc afficher :
...
* RC pro événementiel
* Assurance matériel sono/lumière/photo
...
* Ne pas organiser un événement public sans vérifier mairie, sécurité, ERP et assurance
* Vérifier les droits musicaux et la Sacem pour diffusion musicale
* Éviter les conflits d'intérêt avec le poste public
...
Coûts indicatifs pour **Organisation complète événement** :
...
* Matériel événementiel : 200 à 3 000 €
* RC événementiel : 150 à 500 €/an
* Droits musicaux/Sacem : variable selon événement
...
1. Décrire précisément l’activité Organisation complète événement.
...
id_fiche : fonctionnaire_organisation_complete_evenement
titre : Organisation complète événement — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : Organisation complète événement
...
code_ape_indicatif : 90.02Z, 90.01Z, 74.20Z, 82.30Z ou 93.29Z selon activité — à confirmer
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, Guichet unique INPI, Urssaf, Sacem si musique, Préfecture/mairie si événement public, DRAC/préfecture si spectacle vivant
assurance_obligatoire_ou_recommandee : RC pro événementiel, Assurance matériel sono/lumière/photo, Assurance véhicule pro
