# FICHE MÉTIER — Taille de haies — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Taille de haies
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Taille de haies**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Taille de haies**, l’application doit donc afficher :
...
Coûts indicatifs pour **Taille de haies** :
...
1. Décrire précisément l’activité Taille de haies.
...
id_fiche : fonctionnaire_taille_de_haies
titre : Taille de haies — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Taille de haies
