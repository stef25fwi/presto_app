# FICHE MÉTIER — Organisation / rangement — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Organisation / rangement
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Organisation / rangement**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Organisation / rangement**, l’application doit donc afficher :
...
Coûts indicatifs pour **Organisation / rangement** :
...
1. Décrire précisément l’activité Organisation / rangement.
...
id_fiche : fonctionnaire_organisation_rangement
titre : Organisation / rangement — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Aide à domicile
activite : Organisation / rangement
