# FICHE MÉTIER — Rénovation locative express — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Rénovation locative express
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Rénovation locative express**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Rénovation locative express**, l’application doit donc afficher :
...
Coûts indicatifs pour **Rénovation locative express** :
...
1. Décrire précisément l’activité Rénovation locative express.
...
id_fiche : fonctionnaire_renovation_locative_express
titre : Rénovation locative express — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Rénovation locative express
