# FICHE MÉTIER — Animateur micro / MC — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Animateur micro / MC
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Animateur micro / MC**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Animateur micro / MC**, l’application doit donc afficher :
...
Coûts indicatifs pour **Animateur micro / MC** :
...
1. Décrire précisément l’activité Animateur micro / MC.
...
id_fiche : fonctionnaire_animateur_micro_mc
titre : Animateur micro / MC — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : Animateur micro / MC
