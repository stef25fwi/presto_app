# FICHE MÉTIER — Français / Langues — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Français / Langues
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Français / Langues**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Français / Langues**, l’application doit donc afficher :
...
Coûts indicatifs pour **Français / Langues** :
...
1. Décrire précisément l’activité Français / Langues.
...
id_fiche : fonctionnaire_francais_langues
titre : Français / Langues — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Français / Langues
