# FICHE MÉTIER — Aide débarras / encombrants — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Aide débarras / encombrants
...
Code APE indicatif : 56.10A, 56.10C, 56.21Z ou 56.29B selon activité réelle — à confirmer par l'Insee
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Aide débarras / encombrants**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Aide débarras / encombrants**, l’application doit donc afficher :
...
Coûts indicatifs pour **Aide débarras / encombrants** :
...
1. Décrire précisément l’activité Aide débarras / encombrants.
...
id_fiche : fonctionnaire_aide_debarras_encombrants
titre : Aide débarras / encombrants — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Aide débarras / encombrants
...
code_ape_indicatif : 56.10A, 56.10C, 56.21Z ou 56.29B selon activité réelle — à confirmer par l'Insee
