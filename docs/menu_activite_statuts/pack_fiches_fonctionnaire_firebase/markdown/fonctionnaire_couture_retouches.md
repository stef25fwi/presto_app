# FICHE MÉTIER — Couture / retouches — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Couture / retouches
Statut utilisateur : Fonctionnaire / agent public
Famille : Couture / Retouches
...
Code APE indicatif : 95.29Z ou 14.13Z selon retouche/confection, à confirmer
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Couture / retouches**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Couture / retouches**, l’application doit donc afficher :
...
Coûts indicatifs pour **Couture / retouches** :
...
1. Décrire précisément l’activité Couture / retouches.
...
id_fiche : fonctionnaire_couture_retouches
titre : Couture / retouches — fonctionnaire
...
code_ape_indicatif : 95.29Z ou 14.13Z selon retouche/confection, à confirmer
