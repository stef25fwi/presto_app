# FICHE MÉTIER — Cours de musique — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Cours de musique
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Cours de musique**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Cours de musique**, l’application doit donc afficher :
...
Coûts indicatifs pour **Cours de musique** :
...
1. Décrire précisément l’activité Cours de musique.
...
id_fiche : fonctionnaire_cours_de_musique
titre : Cours de musique — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Cours de musique
