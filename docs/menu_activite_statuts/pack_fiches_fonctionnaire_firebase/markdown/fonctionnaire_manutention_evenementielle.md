# FICHE MÉTIER — Manutention événementielle — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Manutention événementielle
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Manutention événementielle**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Manutention événementielle**, l’application doit donc afficher :
...
Coûts indicatifs pour **Manutention événementielle** :
...
1. Décrire précisément l’activité Manutention événementielle.
...
id_fiche : fonctionnaire_manutention_evenementielle
titre : Manutention événementielle — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Manutention événementielle
