# FICHE MÉTIER — Petit-déjeuner / Brunch — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Petit-déjeuner / Brunch
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Petit-déjeuner / Brunch**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Petit-déjeuner / Brunch**, l’application doit donc afficher :
...
Coûts indicatifs pour **Petit-déjeuner / Brunch** :
...
1. Décrire précisément l’activité Petit-déjeuner / Brunch.
...
id_fiche : fonctionnaire_petit_dejeuner_brunch
titre : Petit-déjeuner / Brunch — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Restauration / Extra
activite : Petit-déjeuner / Brunch
