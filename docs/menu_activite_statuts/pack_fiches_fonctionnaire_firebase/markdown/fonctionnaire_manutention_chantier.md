# FICHE MÉTIER — Manutention chantier — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Manutention chantier
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Manutention chantier**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Manutention chantier**, l’application doit donc afficher :
...
Coûts indicatifs pour **Manutention chantier** :
...
1. Décrire précisément l’activité Manutention chantier.
...
id_fiche : fonctionnaire_manutention_chantier
titre : Manutention chantier — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Manutention chantier
