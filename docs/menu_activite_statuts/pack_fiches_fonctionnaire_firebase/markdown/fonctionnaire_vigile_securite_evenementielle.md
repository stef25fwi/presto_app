# FICHE MÉTIER — Vigile / sécurité événementielle — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Vigile / sécurité événementielle
Statut utilisateur : Fonctionnaire / agent public
Famille : Main-d'oeuvre / Logistique
Type d’activité : Main-d'œuvre ponctuelle, manutention, aide logistique ou service opérationnel
Activité réglementée : oui
Niveau de vigilance : élevé
Code APE indicatif : 82.99Z, 52.29B, 49.42Z, 53.20Z, 78.30Z ou 81.29B selon activité — à confirmer
Nature fiscale probable : prestation_services_bic
Organismes principaux : Administration employeur, Guichet unique INPI, Urssaf, CNAPS si sécurité, DREAL/DEAL si transport routier, Assureur RC pro
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Vigile / sécurité événementielle**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
L’utilisateur fonctionnaire ne doit pas démarrer directement l’activité **Vigile / sécurité événementielle** sans vérifier deux niveaux : d’abord les règles propres aux agents publics, ensuite les règles propres au métier. L’activité doit rester compatible avec le service public, ne pas nuire à la neutralité, à l’indépendance ou au fonctionnement normal du service, et faire l’objet d’une déclaration ou d’une autorisation écrite selon le cas.

### Activité libre ou réglementée

Statut de vigilance : **oui**.

Vérifier le périmètre réel. La simple aide manutention n'autorise pas à exercer une activité de sécurité privée. La sécurité/vigile est réglementée par le CNAPS. Le transport rémunéré de marchandises ou déménagement avec véhicule peut relever de la réglementation transporteur routier. La manutention impose prévention des risques et assurance.
...
Pour **Vigile / sécurité événementielle**, l’application doit donc afficher :
...
* RC pro manutention/logistique
* Assurance véhicule/marchandises transportées
* Assurance accident/protection juridique
...
* Ne pas exercer comme agent de sécurité sans titre CNAPS
* Ne pas faire de transport/déménagement rémunéré avec véhicule sans vérifier réglementation transport
* Prévoir prévention du port de charges
...
Coûts indicatifs pour **Vigile / sécurité événementielle** :
...
* EPI : 30 à 200 €
* Diable/sangles/outillage : 50 à 500 €
* Assurance marchandises/véhicule : variable
...
1. Décrire précisément l’activité Vigile / sécurité événementielle.
...
id_fiche : fonctionnaire_vigile_securite_evenementielle
titre : Vigile / sécurité événementielle — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Vigile / sécurité événementielle
...
code_ape_indicatif : 82.99Z, 52.29B, 49.42Z, 53.20Z, 78.30Z ou 81.29B selon activité — à confirmer
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, Guichet unique INPI, Urssaf, CNAPS si sécurité, DREAL/DEAL si transport routier, Assureur RC pro
assurance_obligatoire_ou_recommandee : RC pro manutention/logistique, Assurance véhicule/marchandises transportées, Assurance accident/protection juridique
...
* https://entreprendre.service-public.gouv.fr/vosdroits/R20031
