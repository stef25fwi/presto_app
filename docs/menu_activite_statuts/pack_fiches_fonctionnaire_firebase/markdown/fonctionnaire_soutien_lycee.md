# FICHE MÉTIER — Soutien lycée — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Soutien lycée
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Soutien lycée**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Soutien lycée**, l’application doit donc afficher :
...
Coûts indicatifs pour **Soutien lycée** :
...
1. Décrire précisément l’activité Soutien lycée.
...
id_fiche : fonctionnaire_soutien_lycee
titre : Soutien lycée — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Soutien lycée
