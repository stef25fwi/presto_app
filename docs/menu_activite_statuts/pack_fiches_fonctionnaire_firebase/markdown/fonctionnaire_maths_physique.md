# FICHE MÉTIER — Maths / Physique — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Maths / Physique
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Maths / Physique**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Maths / Physique**, l’application doit donc afficher :
...
Coûts indicatifs pour **Maths / Physique** :
...
1. Décrire précisément l’activité Maths / Physique.
...
id_fiche : fonctionnaire_maths_physique
titre : Maths / Physique — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Maths / Physique
