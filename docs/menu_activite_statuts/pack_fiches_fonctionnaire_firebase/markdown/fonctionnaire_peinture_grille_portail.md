# FICHE MÉTIER — Peinture grille / portail — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Peinture grille / portail
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Peinture grille / portail**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Peinture grille / portail**, l’application doit donc afficher :
...
Coûts indicatifs pour **Peinture grille / portail** :
...
1. Décrire précisément l’activité Peinture grille / portail.
...
id_fiche : fonctionnaire_peinture_grille_portail
titre : Peinture grille / portail — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Peinture grille / portail
