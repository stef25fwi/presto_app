# FICHE MÉTIER — Traduction — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Traduction
...
Code APE indicatif : 74.30Z — traduction et interprétation, à confirmer
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Traduction**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Traduction**, l’application doit donc afficher :
...
Coûts indicatifs pour **Traduction** :
...
1. Décrire précisément l’activité Traduction.
...
id_fiche : fonctionnaire_traduction
titre : Traduction — fonctionnaire
...
code_ape_indicatif : 74.30Z — traduction et interprétation, à confirmer
