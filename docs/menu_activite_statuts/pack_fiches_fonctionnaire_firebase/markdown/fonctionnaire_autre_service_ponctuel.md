# FICHE MÉTIER — Autre service ponctuel — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Autre service ponctuel
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Autre service ponctuel**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Autre service ponctuel**, l’application doit donc afficher :
...
Coûts indicatifs pour **Autre service ponctuel** :
...
1. Décrire précisément l’activité Autre service ponctuel.
...
id_fiche : fonctionnaire_autre_service_ponctuel
titre : Autre service ponctuel — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Autre
activite : Autre service ponctuel
