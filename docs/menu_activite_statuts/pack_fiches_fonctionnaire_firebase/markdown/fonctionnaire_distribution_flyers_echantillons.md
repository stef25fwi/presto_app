# FICHE MÉTIER — Distribution flyers / échantillons — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Distribution flyers / échantillons
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Distribution flyers / échantillons**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Distribution flyers / échantillons**, l’application doit donc afficher :
...
Coûts indicatifs pour **Distribution flyers / échantillons** :
...
1. Décrire précisément l’activité Distribution flyers / échantillons.
...
id_fiche : fonctionnaire_distribution_flyers_echantillons
titre : Distribution flyers / échantillons — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Distribution flyers / échantillons
