# FICHE MÉTIER — Aide administrative / comptable — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Aide administrative / comptable
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Aide administrative / comptable**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Aide administrative / comptable**, l’application doit donc afficher :
...
Coûts indicatifs pour **Aide administrative / comptable** :
...
1. Décrire précisément l’activité Aide administrative / comptable.
...
id_fiche : fonctionnaire_aide_administrative_comptable
titre : Aide administrative / comptable — fonctionnaire
