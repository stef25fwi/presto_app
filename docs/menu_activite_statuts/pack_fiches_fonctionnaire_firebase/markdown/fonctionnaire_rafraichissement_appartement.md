# FICHE MÉTIER — Rafraîchissement appartement — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Rafraîchissement appartement
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Rafraîchissement appartement**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Rafraîchissement appartement**, l’application doit donc afficher :
...
Coûts indicatifs pour **Rafraîchissement appartement** :
...
1. Décrire précisément l’activité Rafraîchissement appartement.
...
id_fiche : fonctionnaire_rafraichissement_appartement
titre : Rafraîchissement appartement — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Rafraîchissement appartement
