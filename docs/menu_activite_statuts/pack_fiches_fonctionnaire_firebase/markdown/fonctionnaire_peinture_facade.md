# FICHE MÉTIER — Peinture façade — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Peinture façade
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Peinture façade**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Peinture façade**, l’application doit donc afficher :
...
Coûts indicatifs pour **Peinture façade** :
...
1. Décrire précisément l’activité Peinture façade.
...
id_fiche : fonctionnaire_peinture_facade
titre : Peinture façade — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Peinture façade
