# FICHE MÉTIER — Aide aux courses — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Aide aux courses
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Aide aux courses**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Aide aux courses**, l’application doit donc afficher :
...
Coûts indicatifs pour **Aide aux courses** :
...
1. Décrire précisément l’activité Aide aux courses.
...
id_fiche : fonctionnaire_aide_aux_courses
titre : Aide aux courses — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Aide à domicile
activite : Aide aux courses
