# FICHE MÉTIER — Bar / Barman — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Bar / Barman
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Bar / Barman**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Bar / Barman**, l’application doit donc afficher :
...
Coûts indicatifs pour **Bar / Barman** :
...
1. Décrire précisément l’activité Bar / Barman.
...
id_fiche : fonctionnaire_bar_barman
titre : Bar / Barman — fonctionnaire
