# FICHE MÉTIER — Peinture décorative — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Peinture décorative
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Peinture décorative**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Peinture décorative**, l’application doit donc afficher :
...
Coûts indicatifs pour **Peinture décorative** :
...
1. Décrire précisément l’activité Peinture décorative.
...
id_fiche : fonctionnaire_peinture_decorative
titre : Peinture décorative — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Peinture décorative
