# FICHE MÉTIER — Peinture chambre / salon — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Peinture chambre / salon
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Peinture chambre / salon**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Peinture chambre / salon**, l’application doit donc afficher :
...
Coûts indicatifs pour **Peinture chambre / salon** :
...
1. Décrire précisément l’activité Peinture chambre / salon.
...
id_fiche : fonctionnaire_peinture_chambre_salon
titre : Peinture chambre / salon — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Peinture chambre / salon
