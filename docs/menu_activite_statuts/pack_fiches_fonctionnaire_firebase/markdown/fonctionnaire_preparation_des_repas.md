# FICHE MÉTIER — Préparation des repas — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Préparation des repas
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Préparation des repas**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Préparation des repas**, l’application doit donc afficher :
...
Coûts indicatifs pour **Préparation des repas** :
...
1. Décrire précisément l’activité Préparation des repas.
...
id_fiche : fonctionnaire_preparation_des_repas
titre : Préparation des repas — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Aide à domicile
activite : Préparation des repas
