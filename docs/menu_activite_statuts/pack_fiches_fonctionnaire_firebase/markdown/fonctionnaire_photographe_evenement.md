# FICHE MÉTIER — Photographe événement — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Photographe événement
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Photographe événement**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Photographe événement**, l’application doit donc afficher :
...
Coûts indicatifs pour **Photographe événement** :
...
1. Décrire précisément l’activité Photographe événement.
...
id_fiche : fonctionnaire_photographe_evenement
titre : Photographe événement — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : Photographe événement
