# FICHE MÉTIER — Accompagnement activités — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Accompagnement activités
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Accompagnement activités**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Accompagnement activités**, l’application doit donc afficher :
...
Coûts indicatifs pour **Accompagnement activités** :
...
1. Décrire précisément l’activité Accompagnement activités.
...
id_fiche : fonctionnaire_accompagnement_activites
titre : Accompagnement activités — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Garde d'enfants
activite : Accompagnement activités
