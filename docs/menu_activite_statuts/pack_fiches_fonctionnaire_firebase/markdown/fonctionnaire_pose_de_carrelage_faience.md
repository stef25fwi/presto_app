# FICHE MÉTIER — Pose de carrelage / faïence — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Pose de carrelage / faïence
Statut utilisateur : Fonctionnaire / agent public
Famille : Bricolage / Travaux
Type d’activité : Travaux de faible importance chez des particuliers, bricolage ou activité du bâtiment selon périmètre
Activité réglementée : oui
Niveau de vigilance : élevé
Code APE indicatif : 43.21A, 43.22A, 43.33Z, 43.34Z, 43.39Z, 95.22Z ou 95.24Z selon travaux — à confirmer
Nature fiscale probable : prestation_services_bic_artisanale
Organismes principaux : Administration employeur, CMA, Guichet unique INPI, Urssaf, Assureur décennale si travaux du bâtiment
...
* petit chantier déclaré

Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Pose de carrelage / faïence**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
L’utilisateur fonctionnaire ne doit pas démarrer directement l’activité **Pose de carrelage / faïence** sans vérifier deux niveaux : d’abord les règles propres aux agents publics, ensuite les règles propres au métier. L’activité doit rester compatible avec le service public, ne pas nuire à la neutralité, à l’indépendance ou au fonctionnement normal du service, et faire l’objet d’une déclaration ou d’une autorisation écrite selon le cas.

### Activité libre ou réglementée

Statut de vigilance : **oui**.

Les travaux touchant au bâti, à l'électricité, à la plomberie, au carrelage, à la cloison, à la structure ou aux éléments indissociables nécessitent une qualification adaptée : CAP/BP/titre RNCP dans le métier ou 3 ans d'expérience reconnue par la CMA. Le petit bricolage simple, sans modification du bâti ni risque technique, reste à limiter aux travaux de très faible importance.
...
Pour **Pose de carrelage / faïence**, l’application doit donc afficher :
...
* RC pro obligatoire ou fortement recommandée selon périmètre
* Garantie décennale si travaux du bâtiment couverts
* Assurance outillage et véhicule pro
...
* Ne pas présenter une activité de bâtiment sans qualification si elle est réglementée
* Ne pas réaliser de travaux électriques/plomberie structurels sans assurance et qualification
* Délimiter clairement le petit bricolage autorisé
...
Coûts indicatifs pour **Pose de carrelage / faïence** :
...
* Outillage : 100 à 1 500 €
* Décennale si concernée : souvent plusieurs centaines d'euros par an
* EPI : 50 à 300 €
...
1. Décrire précisément l’activité Pose de carrelage / faïence.
...
id_fiche : fonctionnaire_pose_de_carrelage_faience
titre : Pose de carrelage / faïence — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Pose de carrelage / faïence
activite_reglementee : oui
...
code_ape_indicatif : 43.21A, 43.22A, 43.33Z, 43.34Z, 43.39Z, 95.22Z ou 95.24Z selon travaux — à confirmer
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, CMA, Guichet unique INPI, Urssaf, Assureur décennale si travaux du bâtiment
assurance_obligatoire_ou_recommandee : RC pro obligatoire ou fortement recommandée selon périmètre, Garantie décennale si travaux du bâtiment couverts, Assurance outillage et véhicule pro
...
* https://entreprendre.service-public.gouv.fr/vosdroits/F39041
