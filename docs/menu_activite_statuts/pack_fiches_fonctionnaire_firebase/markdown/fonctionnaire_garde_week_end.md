# FICHE MÉTIER — Garde week-end — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Garde week-end
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Garde week-end**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Garde week-end**, l’application doit donc afficher :
...
Coûts indicatifs pour **Garde week-end** :
...
1. Décrire précisément l’activité Garde week-end.
...
id_fiche : fonctionnaire_garde_week_end
titre : Garde week-end — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Garde d'enfants
activite : Garde week-end
