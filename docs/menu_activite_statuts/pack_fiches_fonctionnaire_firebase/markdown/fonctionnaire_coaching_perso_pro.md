# FICHE MÉTIER — Coaching perso / pro — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Coaching perso / pro
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Coaching perso / pro**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Coaching perso / pro**, l’application doit donc afficher :
...
* Ne pas promettre de résultat thérapeutique, médical ou psychologique ; clarifier le périmètre non médical.
...
Coûts indicatifs pour **Coaching perso / pro** :
...
1. Décrire précisément l’activité Coaching perso / pro.
...
id_fiche : fonctionnaire_coaching_perso_pro
titre : Coaching perso / pro — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Autre
activite : Coaching perso / pro
