# FICHE MÉTIER — Réparation électroménager — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Réparation électroménager
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Réparation électroménager**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Réparation électroménager**, l’application doit donc afficher :
...
Coûts indicatifs pour **Réparation électroménager** :
...
1. Décrire précisément l’activité Réparation électroménager.
...
id_fiche : fonctionnaire_reparation_electromenager
titre : Réparation électroménager — fonctionnaire
