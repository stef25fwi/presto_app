# FICHE MÉTIER — Entretien jardin location — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Entretien jardin location
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Entretien jardin location**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Entretien jardin location**, l’application doit donc afficher :
...
Coûts indicatifs pour **Entretien jardin location** :
...
1. Décrire précisément l’activité Entretien jardin location.
...
id_fiche : fonctionnaire_entretien_jardin_location
titre : Entretien jardin location — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Entretien jardin location
