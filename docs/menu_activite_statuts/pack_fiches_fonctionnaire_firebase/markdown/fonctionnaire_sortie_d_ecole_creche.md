# FICHE MÉTIER — Sortie d'école / crèche — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Sortie d'école / crèche
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Sortie d'école / crèche**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Sortie d'école / crèche**, l’application doit donc afficher :
...
Coûts indicatifs pour **Sortie d'école / crèche** :
...
1. Décrire précisément l’activité Sortie d'école / crèche.
...
id_fiche : fonctionnaire_sortie_d_ecole_creche
titre : Sortie d'école / crèche — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Garde d'enfants
activite : Sortie d'école / crèche
