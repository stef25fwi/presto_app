# FICHE MÉTIER — Peinture boiseries — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Peinture boiseries
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Peinture boiseries**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Peinture boiseries**, l’application doit donc afficher :
...
Coûts indicatifs pour **Peinture boiseries** :
...
1. Décrire précisément l’activité Peinture boiseries.
...
id_fiche : fonctionnaire_peinture_boiseries
titre : Peinture boiseries — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Peinture boiseries
