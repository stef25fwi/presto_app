# FICHE MÉTIER — Location sono / lumières — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Location sono / lumières
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Location sono / lumières**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Location sono / lumières**, l’application doit donc afficher :
...
Coûts indicatifs pour **Location sono / lumières** :
...
1. Décrire précisément l’activité Location sono / lumières.
...
id_fiche : fonctionnaire_location_sono_lumieres
titre : Location sono / lumières — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : Location sono / lumières
