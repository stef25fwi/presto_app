# FICHE MÉTIER — Aide aux devoirs primaire — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Aide aux devoirs primaire
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Aide aux devoirs primaire**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Aide aux devoirs primaire**, l’application doit donc afficher :
...
Coûts indicatifs pour **Aide aux devoirs primaire** :
...
1. Décrire précisément l’activité Aide aux devoirs primaire.
...
id_fiche : fonctionnaire_aide_aux_devoirs_primaire
titre : Aide aux devoirs primaire — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Aide aux devoirs primaire
