# FICHE MÉTIER — Ménage régulier — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Ménage régulier
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Ménage régulier**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Ménage régulier**, l’application doit donc afficher :
...
Coûts indicatifs pour **Ménage régulier** :
...
1. Décrire précisément l’activité Ménage régulier.
...
id_fiche : fonctionnaire_menage_regulier
titre : Ménage régulier — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Aide à domicile
activite : Ménage régulier
