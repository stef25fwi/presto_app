# FICHE MÉTIER — Chargement / déchargement — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Chargement / déchargement
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Chargement / déchargement**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Chargement / déchargement**, l’application doit donc afficher :
...
Coûts indicatifs pour **Chargement / déchargement** :
...
1. Décrire précisément l’activité Chargement / déchargement.
...
id_fiche : fonctionnaire_chargement_dechargement
titre : Chargement / déchargement — fonctionnaire
