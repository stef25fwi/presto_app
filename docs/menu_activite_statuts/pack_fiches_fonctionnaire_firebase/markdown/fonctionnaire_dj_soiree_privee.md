# FICHE MÉTIER — DJ soirée privée — fonctionnaire

## 0. Identité de la fiche

Métier / activité : DJ soirée privée
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **DJ soirée privée**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **DJ soirée privée**, l’application doit donc afficher :
...
Coûts indicatifs pour **DJ soirée privée** :
...
1. Décrire précisément l’activité DJ soirée privée.
...
id_fiche : fonctionnaire_dj_soiree_privee
titre : DJ soirée privée — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : DJ soirée privée
