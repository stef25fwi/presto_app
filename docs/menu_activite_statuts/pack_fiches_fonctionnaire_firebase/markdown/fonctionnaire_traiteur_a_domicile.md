# FICHE MÉTIER — Traiteur à domicile — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Traiteur à domicile
...
Code APE indicatif : 56.21Z — services des traiteurs, à confirmer par l'Insee
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Traiteur à domicile**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Traiteur à domicile**, l’application doit donc afficher :
...
Coûts indicatifs pour **Traiteur à domicile** :
...
1. Décrire précisément l’activité Traiteur à domicile.
...
id_fiche : fonctionnaire_traiteur_a_domicile
titre : Traiteur à domicile — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Restauration / Extra
activite : Traiteur à domicile
...
code_ape_indicatif : 56.21Z — services des traiteurs, à confirmer par l'Insee
