# FICHE MÉTIER — Service banquet / Mariage — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Service banquet / Mariage
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Service banquet / Mariage**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Service banquet / Mariage**, l’application doit donc afficher :
...
Coûts indicatifs pour **Service banquet / Mariage** :
...
1. Décrire précisément l’activité Service banquet / Mariage.
...
id_fiche : fonctionnaire_service_banquet_mariage
titre : Service banquet / Mariage — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Restauration / Extra
activite : Service banquet / Mariage
