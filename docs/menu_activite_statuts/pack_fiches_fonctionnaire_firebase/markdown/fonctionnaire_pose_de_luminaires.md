# FICHE MÉTIER — Pose de luminaires — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Pose de luminaires
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Pose de luminaires**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Pose de luminaires**, l’application doit donc afficher :
...
Coûts indicatifs pour **Pose de luminaires** :
...
1. Décrire précisément l’activité Pose de luminaires.
...
id_fiche : fonctionnaire_pose_de_luminaires
titre : Pose de luminaires — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Pose de luminaires
