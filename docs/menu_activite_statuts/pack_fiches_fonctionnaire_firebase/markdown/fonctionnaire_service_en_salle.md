# FICHE MÉTIER — Service en salle — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Service en salle
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Service en salle**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Service en salle**, l’application doit donc afficher :
...
Coûts indicatifs pour **Service en salle** :
...
1. Décrire précisément l’activité Service en salle.
...
id_fiche : fonctionnaire_service_en_salle
titre : Service en salle — fonctionnaire
