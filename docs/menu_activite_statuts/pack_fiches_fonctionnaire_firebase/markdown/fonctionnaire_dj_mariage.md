# FICHE MÉTIER — DJ mariage — fonctionnaire

## 0. Identité de la fiche

Métier / activité : DJ mariage
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **DJ mariage**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **DJ mariage**, l’application doit donc afficher :
...
Coûts indicatifs pour **DJ mariage** :
...
1. Décrire précisément l’activité DJ mariage.
...
id_fiche : fonctionnaire_dj_mariage
titre : DJ mariage — fonctionnaire
