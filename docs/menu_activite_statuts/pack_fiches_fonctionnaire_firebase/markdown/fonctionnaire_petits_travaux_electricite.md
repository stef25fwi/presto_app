# FICHE MÉTIER — Petits travaux électricité — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Petits travaux électricité
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Petits travaux électricité**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Petits travaux électricité**, l’application doit donc afficher :
...
Coûts indicatifs pour **Petits travaux électricité** :
...
1. Décrire précisément l’activité Petits travaux électricité.
...
id_fiche : fonctionnaire_petits_travaux_electricite
titre : Petits travaux électricité — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Petits travaux électricité
