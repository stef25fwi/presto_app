# FICHE MÉTIER — Inventaire magasin — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Inventaire magasin
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Inventaire magasin**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Inventaire magasin**, l’application doit donc afficher :
...
Coûts indicatifs pour **Inventaire magasin** :
...
1. Décrire précisément l’activité Inventaire magasin.
...
id_fiche : fonctionnaire_inventaire_magasin
titre : Inventaire magasin — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Main-d'oeuvre
activite : Inventaire magasin
