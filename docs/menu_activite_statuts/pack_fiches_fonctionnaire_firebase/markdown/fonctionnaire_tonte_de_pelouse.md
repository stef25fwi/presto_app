# FICHE MÉTIER — Tonte de pelouse — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Tonte de pelouse
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Tonte de pelouse**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Tonte de pelouse**, l’application doit donc afficher :
...
Coûts indicatifs pour **Tonte de pelouse** :
...
1. Décrire précisément l’activité Tonte de pelouse.
...
id_fiche : fonctionnaire_tonte_de_pelouse
titre : Tonte de pelouse — fonctionnaire
