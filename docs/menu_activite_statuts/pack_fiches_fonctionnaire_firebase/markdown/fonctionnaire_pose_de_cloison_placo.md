# FICHE MÉTIER — Pose de cloison / placo — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Pose de cloison / placo
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Pose de cloison / placo**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Pose de cloison / placo**, l’application doit donc afficher :
...
Coûts indicatifs pour **Pose de cloison / placo** :
...
1. Décrire précisément l’activité Pose de cloison / placo.
...
id_fiche : fonctionnaire_pose_de_cloison_placo
titre : Pose de cloison / placo — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Pose de cloison / placo
