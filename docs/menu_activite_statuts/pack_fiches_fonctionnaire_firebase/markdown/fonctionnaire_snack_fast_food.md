# FICHE MÉTIER — Snack / Fast-food — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Snack / Fast-food
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Snack / Fast-food**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Snack / Fast-food**, l’application doit donc afficher :
...
Coûts indicatifs pour **Snack / Fast-food** :
...
1. Décrire précisément l’activité Snack / Fast-food.
...
id_fiche : fonctionnaire_snack_fast_food
titre : Snack / Fast-food — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Restauration / Extra
activite : Snack / Fast-food
