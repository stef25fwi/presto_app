# FICHE MÉTIER — Entretien potager — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Entretien potager
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Entretien potager**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Entretien potager**, l’application doit donc afficher :
...
Coûts indicatifs pour **Entretien potager** :
...
1. Décrire précisément l’activité Entretien potager.
...
id_fiche : fonctionnaire_entretien_potager
titre : Entretien potager — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Entretien potager
