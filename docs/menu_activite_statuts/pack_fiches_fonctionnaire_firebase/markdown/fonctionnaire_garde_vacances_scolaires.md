# FICHE MÉTIER — Garde vacances scolaires — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Garde vacances scolaires
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Garde vacances scolaires**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Garde vacances scolaires**, l’application doit donc afficher :
...
Coûts indicatifs pour **Garde vacances scolaires** :
...
1. Décrire précisément l’activité Garde vacances scolaires.
...
id_fiche : fonctionnaire_garde_vacances_scolaires
titre : Garde vacances scolaires — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Garde d'enfants
activite : Garde vacances scolaires
