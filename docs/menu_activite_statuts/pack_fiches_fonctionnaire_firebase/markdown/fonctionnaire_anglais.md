# FICHE MÉTIER — Anglais — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Anglais
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Anglais**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Anglais**, l’application doit donc afficher :
...
1. Décrire précisément l’activité Anglais.
...
id_fiche : fonctionnaire_anglais
titre : Anglais — fonctionnaire
