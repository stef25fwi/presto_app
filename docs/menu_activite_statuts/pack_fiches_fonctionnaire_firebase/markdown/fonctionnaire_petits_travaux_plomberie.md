# FICHE MÉTIER — Petits travaux plomberie — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Petits travaux plomberie
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Petits travaux plomberie**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Petits travaux plomberie**, l’application doit donc afficher :
...
Coûts indicatifs pour **Petits travaux plomberie** :
...
1. Décrire précisément l’activité Petits travaux plomberie.
...
id_fiche : fonctionnaire_petits_travaux_plomberie
titre : Petits travaux plomberie — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Petits travaux plomberie
