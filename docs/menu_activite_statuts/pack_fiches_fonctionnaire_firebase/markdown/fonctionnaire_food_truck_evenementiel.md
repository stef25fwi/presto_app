# FICHE MÉTIER — Food truck / Événementiel — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Food truck / Événementiel
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Food truck / Événementiel**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Food truck / Événementiel**, l’application doit donc afficher :
...
Coûts indicatifs pour **Food truck / Événementiel** :
...
1. Décrire précisément l’activité Food truck / Événementiel.
...
id_fiche : fonctionnaire_food_truck_evenementiel
titre : Food truck / Événementiel — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Restauration / Extra
activite : Food truck / Événementiel
