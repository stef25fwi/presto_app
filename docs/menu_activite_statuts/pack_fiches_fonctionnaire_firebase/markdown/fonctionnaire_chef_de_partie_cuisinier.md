# FICHE MÉTIER — Chef de partie / Cuisinier — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Chef de partie / Cuisinier
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Chef de partie / Cuisinier**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Chef de partie / Cuisinier**, l’application doit donc afficher :
...
Coûts indicatifs pour **Chef de partie / Cuisinier** :
...
1. Décrire précisément l’activité Chef de partie / Cuisinier.
...
id_fiche : fonctionnaire_chef_de_partie_cuisinier
titre : Chef de partie / Cuisinier — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Restauration / Extra
activite : Chef de partie / Cuisinier
