# FICHE MÉTIER — Espagnol — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Espagnol
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Espagnol**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Espagnol**, l’application doit donc afficher :
...
Coûts indicatifs pour **Espagnol** :
...
1. Décrire précisément l’activité Espagnol.
...
id_fiche : fonctionnaire_espagnol
titre : Espagnol — fonctionnaire
