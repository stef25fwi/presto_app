# FICHE MÉTIER — Initiation informatique — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Initiation informatique
Statut utilisateur : Fonctionnaire / agent public
Famille : Cours & soutien
Type d’activité : Enseignement, formation, soutien scolaire ou coaching
Activité réglementée : non / à vérifier selon périmètre
Niveau de vigilance : moyen
Code APE indicatif : 62.09Z ou 62.02A — dépannage/conseil informatique, à confirmer
Nature fiscale probable : prestation_services_bnc_ou_bic
Organismes principaux : Administration employeur, Guichet unique INPI, Urssaf, Nova SAP si soutien scolaire à domicile, Service départemental jeunesse/sport si activité sportive
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Initiation informatique**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Initiation informatique**, l’application doit donc afficher :
...
* RC pro formation/coaching
* Assurance local/salle si accueil public
* Assurance accident si sport
...
* Pour sport/fitness, vérifier diplôme et carte professionnelle avant toute prestation rémunérée
* Ne pas accéder aux données personnelles du client sans accord explicite ; prévoir confidentialité et sauvegarde.
...
Coûts indicatifs pour **Initiation informatique** :
...
* Supports pédagogiques : 20 à 300 €
* Plateforme/visio : 0 à 200 €/an
* RC pro : 100 à 300 €/an
...
1. Décrire précisément l’activité Initiation informatique.
...
id_fiche : fonctionnaire_initiation_informatique
titre : Initiation informatique — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Initiation informatique
...
code_ape_indicatif : 62.09Z ou 62.02A — dépannage/conseil informatique, à confirmer
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, Guichet unique INPI, Urssaf, Nova SAP si soutien scolaire à domicile, Service départemental jeunesse/sport si activité sportive
assurance_obligatoire_ou_recommandee : RC pro formation/coaching, Assurance local/salle si accueil public, Assurance accident si sport
