# FICHE MÉTIER — Plonge / Vaisselle — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Plonge / Vaisselle
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Plonge / Vaisselle**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Plonge / Vaisselle**, l’application doit donc afficher :
...
Coûts indicatifs pour **Plonge / Vaisselle** :
...
1. Décrire précisément l’activité Plonge / Vaisselle.
...
id_fiche : fonctionnaire_plonge_vaisselle
titre : Plonge / Vaisselle — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Restauration / Extra
activite : Plonge / Vaisselle
