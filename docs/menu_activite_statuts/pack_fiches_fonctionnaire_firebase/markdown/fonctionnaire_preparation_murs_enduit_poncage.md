# FICHE MÉTIER — Préparation murs (enduit, ponçage) — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Préparation murs (enduit, ponçage)
Statut utilisateur : Fonctionnaire / agent public
Famille : Peinture / Rénovation
Type d’activité : Activité artisanale du bâtiment ou petits travaux selon périmètre
Activité réglementée : oui
Niveau de vigilance : élevé
Code APE indicatif : 43.34Z — travaux de peinture et vitrerie, à confirmer
Nature fiscale probable : prestation_services_bic_artisanale
Organismes principaux : Administration employeur, CMA, Guichet unique INPI, Urssaf, Assureur RC pro/décennale
...
* rafraîchissement
* rénovation locative
* façade si qualification et assurance

Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Préparation murs (enduit, ponçage)**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Préparation murs (enduit, ponçage)**, l’application doit donc afficher :
...
* RC pro
* Garantie décennale selon travaux
* Assurance outillage/véhicule
...
* Ne pas ouvrir une activité peinture/bâtiment sans qualification et assurance adaptées
* Vérifier les travaux en hauteur, façade, échafaudage et sécurité
...
Coûts indicatifs pour **Préparation murs (enduit, ponçage)** :
...
* Matériel peinture : 150 à 1 000 €
* EPI et protections : 50 à 300 €
* Décennale si concernée : coût variable
...
1. Décrire précisément l’activité Préparation murs (enduit, ponçage).
...
id_fiche : fonctionnaire_preparation_murs_enduit_poncage
titre : Préparation murs (enduit, ponçage) — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Préparation murs (enduit, ponçage)
...
code_ape_indicatif : 43.34Z — travaux de peinture et vitrerie, à confirmer
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, CMA, Guichet unique INPI, Urssaf, Assureur RC pro/décennale
assurance_obligatoire_ou_recommandee : RC pro, Garantie décennale selon travaux, Assurance outillage/véhicule
