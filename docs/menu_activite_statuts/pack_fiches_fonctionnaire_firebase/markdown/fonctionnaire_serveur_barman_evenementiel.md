# FICHE MÉTIER — Serveur / barman événementiel — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Serveur / barman événementiel
Statut utilisateur : Fonctionnaire / agent public
Famille : Restauration / Extra
Type d’activité : Prestation alimentaire, restauration, extra ou service événementiel
Activité réglementée : oui
Niveau de vigilance : élevé
Code APE indicatif : 56.10C — restauration de type rapide / food truck, à confirmer par l'Insee
Nature fiscale probable : prestation_services_bic
Organismes principaux : Administration employeur, Guichet unique INPI, Urssaf, DDPP/DAAF ou DRAAF, Mairie ou préfecture si alcool/AOT, CCI/CMA si ambulant
...
* événement privé
* marché ou emplacement temporaire
* food truck si concerné

Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Serveur / barman événementiel**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Serveur / barman événementiel**, l’application doit donc afficher :
...
* Assurance véhicule usage pro si transport de matériel/denrées
...
* Ne pas occuper le domaine public sans AOT si activité ambulante
* Le service de boissons alcooliques suppose que l'organisateur ou l'établissement dispose des autorisations nécessaires ; un agent public doit éviter toute activité incompatible avec sa fonction.
...
Coûts indicatifs pour **Serveur / barman événementiel** :
...
* Formation hygiène alimentaire : souvent 200 à 500 €
* Licence/alcool/permis d'exploitation : coût variable
* Matériel alimentaire, froid, EPI : 150 à 1 500 €
* AOT ou emplacement : coût variable selon commune
...
1. Décrire précisément l’activité Serveur / barman événementiel.
...
id_fiche : fonctionnaire_serveur_barman_evenementiel
titre : Serveur / barman événementiel — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : Serveur / barman événementiel
...
code_ape_indicatif : 56.10C — restauration de type rapide / food truck, à confirmer par l'Insee
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, Guichet unique INPI, Urssaf, DDPP/DAAF ou DRAAF, Mairie ou préfecture si alcool/AOT, CCI/CMA si ambulant
assurance_obligatoire_ou_recommandee : RC pro restauration/événementiel, Assurance intoxication alimentaire, Assurance véhicule usage pro si transport de matériel/denrées
...
* https://entreprendre.service-public.gouv.fr/vosdroits/R17520
* https://entreprendre.service-public.gouv.fr/vosdroits/F22379
* https://entreprendre.service-public.gouv.fr/vosdroits/R15902
* https://entreprendre.service-public.gouv.fr/vosdroits/F21856
* https://entreprendre.service-public.gouv.fr/vosdroits/F32351
