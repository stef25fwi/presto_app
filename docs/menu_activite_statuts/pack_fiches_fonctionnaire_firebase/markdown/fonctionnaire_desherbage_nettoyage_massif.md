# FICHE MÉTIER — Désherbage / nettoyage massif — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Désherbage / nettoyage massif
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Désherbage / nettoyage massif**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Désherbage / nettoyage massif**, l’application doit donc afficher :
...
Coûts indicatifs pour **Désherbage / nettoyage massif** :
...
1. Décrire précisément l’activité Désherbage / nettoyage massif.
...
id_fiche : fonctionnaire_desherbage_nettoyage_massif
titre : Désherbage / nettoyage massif — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Désherbage / nettoyage massif
