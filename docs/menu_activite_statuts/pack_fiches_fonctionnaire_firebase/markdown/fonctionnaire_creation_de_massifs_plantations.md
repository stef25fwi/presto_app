# FICHE MÉTIER — Création de massifs / plantations — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Création de massifs / plantations
Statut utilisateur : Fonctionnaire / agent public
Famille : Jardinage
Type d’activité : Petits travaux de jardinage chez des particuliers ou entretien d'espaces verts
Activité réglementée : non / à vérifier selon périmètre
Niveau de vigilance : moyen
Code APE indicatif : 81.30Z — services d'aménagement paysager, à confirmer
Nature fiscale probable : prestation_services_bic_artisanale
Organismes principaux : Administration employeur, Guichet unique INPI, Urssaf, Nova SAP si SAP, Mairie/déchèterie pour déchets verts
...
* entretien régulier
* mission ponctuelle
* petits travaux de jardinage SAP

Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Création de massifs / plantations**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Création de massifs / plantations**, l’application doit donc afficher :
...
* Ne pas faire d'élagage dangereux ou travail en hauteur sans assurance/compétence
* Vérifier l'évacuation des déchets verts et les règles communales
...
Coûts indicatifs pour **Création de massifs / plantations** :
...
* Matériel jardinage : 150 à 1 500 €
* EPI : 50 à 300 €
* Évacuation végétaux : variable
...
1. Décrire précisément l’activité Création de massifs / plantations.
...
id_fiche : fonctionnaire_creation_de_massifs_plantations
titre : Création de massifs / plantations — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Création de massifs / plantations
...
code_ape_indicatif : 81.30Z — services d'aménagement paysager, à confirmer
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, Guichet unique INPI, Urssaf, Nova SAP si SAP, Mairie/déchèterie pour déchets verts
assurance_obligatoire_ou_recommandee : RC pro jardinage, Assurance matériel, Assurance véhicule/remorque
