# FICHE MÉTIER — Pose de tringles / étagères — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Pose de tringles / étagères
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Pose de tringles / étagères**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Pose de tringles / étagères**, l’application doit donc afficher :
...
Coûts indicatifs pour **Pose de tringles / étagères** :
...
1. Décrire précisément l’activité Pose de tringles / étagères.
...
id_fiche : fonctionnaire_pose_de_tringles_etageres
titre : Pose de tringles / étagères — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Bricolage / Travaux
activite : Pose de tringles / étagères
