# FICHE MÉTIER — Soutien collège — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Soutien collège
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Soutien collège**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Soutien collège**, l’application doit donc afficher :
...
Coûts indicatifs pour **Soutien collège** :
...
1. Décrire précisément l’activité Soutien collège.
...
id_fiche : fonctionnaire_soutien_college
titre : Soutien collège — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Cours & soutien
activite : Soutien collège
