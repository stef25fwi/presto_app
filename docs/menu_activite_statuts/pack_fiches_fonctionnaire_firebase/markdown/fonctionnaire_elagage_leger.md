# FICHE MÉTIER — Élagage léger — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Élagage léger
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Élagage léger**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Élagage léger**, l’application doit donc afficher :
...
Coûts indicatifs pour **Élagage léger** :
...
1. Décrire précisément l’activité Élagage léger.
...
id_fiche : fonctionnaire_elagage_leger
titre : Élagage léger — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Élagage léger
