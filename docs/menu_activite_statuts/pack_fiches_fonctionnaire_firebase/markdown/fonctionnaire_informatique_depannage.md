...
Métier / activité : Informatique / dépannage
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Informatique / dépannage**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Informatique / dépannage**, l’application doit donc afficher :
...
Coûts indicatifs pour **Informatique / dépannage** :
...
1. Décrire précisément l’activité Informatique / dépannage.
...
id_fiche : fonctionnaire_informatique_depannage
titre : Informatique / dépannage — fonctionnaire
