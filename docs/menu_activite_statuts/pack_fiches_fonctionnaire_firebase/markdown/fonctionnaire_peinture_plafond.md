# FICHE MÉTIER — Peinture plafond — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Peinture plafond
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Peinture plafond**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Peinture plafond**, l’application doit donc afficher :
...
Coûts indicatifs pour **Peinture plafond** :
...
1. Décrire précisément l’activité Peinture plafond.
...
id_fiche : fonctionnaire_peinture_plafond
titre : Peinture plafond — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Peinture
activite : Peinture plafond
