# FICHE MÉTIER — Décoration de salle — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Décoration de salle
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Décoration de salle**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Décoration de salle**, l’application doit donc afficher :
...
Coûts indicatifs pour **Décoration de salle** :
...
1. Décrire précisément l’activité Décoration de salle.
...
id_fiche : fonctionnaire_decoration_de_salle
titre : Décoration de salle — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Événementiel / DJ
activite : Décoration de salle
