# FICHE MÉTIER — Réseaux sociaux / contenu — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Réseaux sociaux / contenu
...
Code APE indicatif : 73.11Z ou 70.21Z — communication/contenu, à confirmer
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Réseaux sociaux / contenu**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Réseaux sociaux / contenu**, l’application doit donc afficher :
...
* Prévoir droits d'auteur, droit à l'image, validation client et règles publicitaires.
...
Coûts indicatifs pour **Réseaux sociaux / contenu** :
...
1. Décrire précisément l’activité Réseaux sociaux / contenu.
...
id_fiche : fonctionnaire_reseaux_sociaux_contenu
titre : Réseaux sociaux / contenu — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Autre
activite : Réseaux sociaux / contenu
...
code_ape_indicatif : 73.11Z ou 70.21Z — communication/contenu, à confirmer
