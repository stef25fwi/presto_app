# FICHE MÉTIER — Débroussaillage — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Débroussaillage
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Débroussaillage**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Débroussaillage**, l’application doit donc afficher :
...
Coûts indicatifs pour **Débroussaillage** :
...
1. Décrire précisément l’activité Débroussaillage.
...
id_fiche : fonctionnaire_debroussaillage
titre : Débroussaillage — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Jardinage
activite : Débroussaillage
