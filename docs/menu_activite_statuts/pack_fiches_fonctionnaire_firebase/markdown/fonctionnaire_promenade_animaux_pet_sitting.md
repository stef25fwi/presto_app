# FICHE MÉTIER — Promenade animaux / pet-sitting — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Promenade animaux / pet-sitting
Statut utilisateur : Fonctionnaire / agent public
Famille : Autre service ponctuel
Type d’activité : Prestation de service indépendante, souvent libérale ou artisanale selon le cas
Activité réglementée : oui
Niveau de vigilance : élevé
Code APE indicatif : 62.02A, 73.11Z, 74.30Z, 96.09Z, 95.29Z ou 82.99Z selon activité — à confirmer
Nature fiscale probable : prestation_services_bnc_ou_bic
Organismes principaux : Administration employeur, Guichet unique INPI, Urssaf, CNIL/RGPD si données, Organisme compétent si activité animale ou réglementée
...
* service créatif
* conseil non réglementé

Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Promenade animaux / pet-sitting**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Promenade animaux / pet-sitting**, l’application doit donc afficher :
...
* RC pro
* Assurance cyber si informatique
* Assurance matériel si photo/vidéo
* Assurance animalier si pet-sitting
...
* Ne pas se présenter comme professionnel réglementé sans titre
* Vérifier RGPD si données clients
* Vérifier droits d'auteur et droit à l'image si contenu/photo
* Vérifier les obligations pour garde d'animaux domestiques, notamment chiens/chats, et l'assurance morsure/dommage.
...
Coûts indicatifs pour **Promenade animaux / pet-sitting** :
...
* Outils logiciels : 0 à 500 €/an
* RC pro : 100 à 400 €/an
* Matériel spécifique : variable
...
1. Décrire précisément l’activité Promenade animaux / pet-sitting.
...
id_fiche : fonctionnaire_promenade_animaux_pet_sitting
titre : Promenade animaux / pet-sitting — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Autre
activite : Promenade animaux / pet-sitting
...
code_ape_indicatif : 62.02A, 73.11Z, 74.30Z, 96.09Z, 95.29Z ou 82.99Z selon activité — à confirmer
organisme_formalite : Guichet unique INPI
organisme_cumul : administration employeur / autorité hiérarchique
organismes_accompagnement : Administration employeur, Guichet unique INPI, Urssaf, CNIL/RGPD si données, Organisme compétent si activité animale ou réglementée
assurance_obligatoire_ou_recommandee : RC pro, Assurance cyber si informatique, Assurance matériel si photo/vidéo, Assurance animalier si pet-sitting
