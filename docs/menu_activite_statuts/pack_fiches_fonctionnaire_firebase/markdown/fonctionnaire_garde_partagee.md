# FICHE MÉTIER — Garde partagée — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Garde partagée
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Garde partagée**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Garde partagée**, l’application doit donc afficher :
...
Coûts indicatifs pour **Garde partagée** :
...
1. Décrire précisément l’activité Garde partagée.
...
id_fiche : fonctionnaire_garde_partagee
titre : Garde partagée — fonctionnaire
statut_utilisateur : fonctionnaire
categorie : Garde d'enfants
activite : Garde partagée
