# FICHE MÉTIER — Repassage — fonctionnaire

## 0. Identité de la fiche

Métier / activité : Repassage
...
Cette fiche sert de base de données pour alimenter automatiquement un parcours “Je me lance” lorsqu’un utilisateur sélectionne le statut **Fonctionnaire** et l’activité **Repassage**. Le code APE reste indicatif : il est attribué ou confirmé selon l’activité réellement déclarée.
...
Pour **Repassage**, l’application doit donc afficher :
...
Coûts indicatifs pour **Repassage** :
...
1. Décrire précisément l’activité Repassage.
...
id_fiche : fonctionnaire_repassage
titre : Repassage — fonctionnaire
