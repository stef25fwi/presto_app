...
void main() {
  testWidgets(
      'Publication d\'une offre - bouton en bas et validation formulaire',
    ...
    final publishButton =
        find.widgetWithText(ElevatedButton, "Publier l'offre");
    ...
    await tester.enterText(
        find.byType(TextFormField).at(1), 'Description test');
