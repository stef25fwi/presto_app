...
import { IS_EMULATOR, PROJECT_REGION } from "../../config/env";
 ...
 *
 * Les tests d'intégration V2 provisionnent explicitement leurs documents
 * utilisateurs. Sous Functions Emulator, ne pas enregistrer ce trigger v1
 * évite de charger l'ancien chemin d'initialisation firebase-functions v1
 * devenu incompatible avec firebase-functions v7. La production conserve
 * strictement le trigger historique.
 */
export const onAuthUserCreated = IS_EMULATOR
  ? undefined
  : functionsV1
