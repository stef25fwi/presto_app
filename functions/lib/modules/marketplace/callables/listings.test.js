...
(0, node_test_1.default)("submitListingDraft delays publication by 30 seconds when photos are present", () => {
    const autoPublishAfter = (0, listings_1.buildAutoPublishAfterForSubmission)({
        mediaCount: 2,
        nowMs: 1_700_000_000_000,
    });
    strict_1.default.ok(autoPublishAfter);
    strict_1.default.equal(autoPublishAfter?.toMillis(), 1_700_000_030_000);
});
