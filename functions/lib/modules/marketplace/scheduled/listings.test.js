...
(0, node_test_1.default)("publishes approved pending listings once the 30 second delay has elapsed", () => {
    const now = firebase_admin_1.default.firestore.Timestamp.fromMillis(1_700_000_030_000);
    const thirtySecondsEarlier = firebase_admin_1.default.firestore.Timestamp.fromMillis(1_700_000_000_000);
...
(0, node_test_1.default)("does not publish approved pending listings before the 30 second delay elapses", () => {
    const now = firebase_admin_1.default.firestore.Timestamp.fromMillis(1_700_000_000_000);
    const thirtySecondsLater = firebase_admin_1.default.firestore.Timestamp.fromMillis(1_700_000_030_000);
    const ready = (0, listings_1.isListingReadyForScheduledPublication)({
        status: "pending",
        moderationStatus: "approved",
        mediaProcessingStatus: "completed",
