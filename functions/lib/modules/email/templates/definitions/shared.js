...
function buildEmailHtml({ title, previewText, intro, body, ctaLabel, ctaVariable, secondaryLabel, secondaryVariable, footer, tone, type, }) {
...
function buildEmailText({ title, previewText, intro, body, ctaLabel, ctaVariable, secondaryLabel, secondaryVariable, footer, }) {
    const lines = [
        "e-livre resto",
        "",
        title,
