...
exports.getPublicLegalConfig = void 0;
exports.sanitizePublicLegalConfig = sanitizePublicLegalConfig;
...
function sanitizePublicLegalConfig(value) {
    ...
    return {
        operatingMode,
        legalVersion: limitedString(data.legalVersion, 80, operatingMode === "commercial" ? "commercial-v1" : "beta-free-v1"),
        cguVersion: limitedString(data.cguVersion, 80, operatingMode === "commercial" ? "cgu-commercial-v1" : "cgu-beta-free-v1"),
        privacyVersion: limitedString(data.privacyVersion, 80, operatingMode === "commercial" ? "privacy-commercial-v1" : "privacy-beta-free-v1"),
        ...
        publisher: {
            ...
            hostingProvider: limitedString(publisher.hostingProvider, 200, "Google Ireland Limited (Firebase Hosting)"),
            hostingAddress: limitedString(publisher.hostingAddress, 500, "Gordon House, Barrow Street, Dublin 4, Irlande"),
        },
    };
}
exports.getPublicLegalConfig = (0, https_1.onCall)({
    ...
    const snapshot = await firestore_1.db.collection("app_config").doc("legal").get();
    return sanitizePublicLegalConfig(snapshot.data());
});
//# sourceMappingURL=public_legal_config.js.map